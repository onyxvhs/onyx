    ...
    <>
      ...
      <div className="min-h-screen retrowave-bg relative overflow-hidden">
        <div className="fixed inset-0 opacity-20 z-0">
          <div className="absolute inset-0 bg-[linear-gradient(90deg,transparent_24%,rgba(255,0,128,0.3)_25%,rgba(255,0,128,0.3)_26%,transparent_27%,transparent_74%,rgba(0,255,255,0.3)_75%,rgba(0,255,255,0.3)_76%,transparent_77%,transparent)] bg-[length:60px_60px] retrowave-grid"></div>
